...
{
  /// <summary>
  /// Wraps a variable in a class that triggers an event if the value changes.
  /// This is useful when values can be meaningfully compared using Equals, and when the variable changes infrequently
  /// in comparison to the number of times it is updated.
  /// </summary>
